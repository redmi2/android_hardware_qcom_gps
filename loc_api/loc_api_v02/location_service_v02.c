...
GENERAL DESCRIPTION
  ...
  $Header: //components/rel/qmimsgs.mpss/3.5/loc/src/location_service_v02.c#25 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====* 
...
static const uint8_t qmiLocAddCircularGeofenceReqMsgT_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(qmiLocAddCircularGeofenceReqMsgT_v02, customResponsivenessValue) - QMI_IDL_OFFSET8(qmiLocAddCircularGeofenceReqMsgT_v02, customResponsivenessValue_valid)),
  0x12,
   QMI_IDL_GENERIC_4_BYTE,
...
static const qmi_idl_service_message_table_entry loc_service_command_messages_v02[] = {
  ...
  {QMI_LOC_ADD_CIRCULAR_GEOFENCE_REQ_V02, QMI_IDL_TYPE16(0, 120), 59},
